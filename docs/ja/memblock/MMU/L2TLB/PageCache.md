...
Table: Page Cache のエントリ構成 {#tbl:PageCache-config}
...
Table: Page Cache エントリに格納する必要がある情報 {#tbl:PageCache-store-info}
...
Table: ページテーブルエントリの属性ビット {#tbl:PageCache-item-attribute}
...
Table: ページテーブルエントリの X、W、R ビットの可能な組み合わせとその意味 {#tbl:PageCache-item-xwr}
